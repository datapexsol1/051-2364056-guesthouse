              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                      ...
                      <asp:DropDownList ID="branches" runat="server"  CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="branches_SelectedIndexChanged">
...
<div class="row">
        <div class="col-md-4">
         ...
         bill type
    <asp:DropDownList ID="employe" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="employe_SelectedIndexChanged" >
