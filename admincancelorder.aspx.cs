...
public partial class admincancelorder : System.Web.UI.Page
{
    ...
    protected void branchselectedindexchange(object sender, EventArgs e)
    {
        if (brid.SelectedValue != "Select Branch")
        {
            int bid = branchClass.getBranchID(brid.SelectedValue); // employeeProfile.getEmployeBranch("kk");
                                                                   //get from session
