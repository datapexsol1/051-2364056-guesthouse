...
public partial class employepaysalary : System.Web.UI.Page
{
    ...
    protected void savebtnclick(object sender, EventArgs e)
    {
        ...
        if (tbpaidvalue.Value != null && tbpaidvalue.Value != "")
        {
            ...
            if (check == true)
            {
                admin_notification_class.addnotification(employID, branchID, DateTime.Now, admin_notification_class.TableNames.event_calender.ToString(), int.Parse(tbid.Value), admin_notification_class.CommandType.Update.ToString(),"yes");
    ...
    protected void updateSalary2(object sender, EventArgs e)
    {
        ...
        if (check == true)
        {
            ...
            admin_notification_class.addnotification(eid, bid, DateTime.Now, admin_notification_class.TableNames.bill.ToString(), hiddenid, admin_notification_class.CommandType.Update.ToString(),"yes");
            msg = "Successfully updated the information";
            type = "Success";
