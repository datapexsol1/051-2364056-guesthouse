                        ...
                        <div class="container">
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    ...
                                    <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false" onclick="myfunction()" >Update Rooms</a></li>
                                ...
                                <div id="myTabContent" class="tab-content">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-condensed">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label id="froomid"><%=r.room_no%></label></td>
                                                        <td>
                                                            <label id="froomtype"><%=r.room_type %></label></td>
                                                        <td>
                                                            <label id="froomsize"><%=r.room_size%></label></td>
                                                        <td>
                                                            <label id="froomrent"><%=r.maximum_room_rent %></label></td>
                                                        <td>
                                                            <label id="froombranch"><%=r.branch_id %></label></td>
                                                        <% if (r.availbilty == "yes")
                                                            { %>
                                                        <td>
                                                            <label id="availbiltyroomy" style="color: green">Available</label></td>
                                                        <%}
                                                            else
                                                            { %>
                                                        <td>
                                                            <label id="availbiltyroomn" style="color: red">Booked</label></td>
                                                        <%} %>
                                                    </tr>
                                                    <%} %>
                                                </tbody>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                        ...
                                        <div class="item form-group col-md-6">
                                            <label class="control-label col-md-4 " for="room no">
                                        ...
                                        <div class="item form-group col-md-6">
                                            <label class="control-label col-md-4 " for="room type">
                                        ...
                                        <div class="item form-group col-md-6">
                                            <label class="control-label col-md-4 " for="room size">
                                        ...
                                        <div class="item form-group col-md-6">
                                            <label class="control-label col-md-4 " for="room rent">
                                                Max Room Rent <span class="required">*</span>
                                            </label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="item form-group col-md-6">
                                            <label class="control-label col-md-4 " for="room rent">
                                                Min Room Rent <span class="required">*</span>
                                            </label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="control-label col-md-4 " for="branch no">
