<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="_Default" %>
...
-->
	...
	<section class="container tm-home-section-1" id="more">
		<div class="row">
			<!-- slider -->
			<div style="margin-top:80px;" class="flexslider effect2 effect2-contact tm-contact-box-1">
				<ul class="slides">
					<li>
