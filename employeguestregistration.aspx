 ...
 <div  class="form-vertical">
     ...
     <div class="form-group">
                          ...
                          <div class="form-group">--%>
                              ...
                              <input type="text" id="cnicno" name="cnicno"   class="form-control col-md-7 col-xs-12" required="required" data-inputmask="'mask' : '99999-9999999-9'"/>
                            </div>
...
<div id="s3" style="padding-top:10px;">
 <div class="form-vertical form-label-left">
                          ...
                          <div class="form-group">--%>
                              ...
                              <input type="text" id="fcnicno" name="fcnicno"  class="form-control col-md-7 col-xs-12" data-inputmask="'mask' : '99999-9999999-9'"/>
                            </div>
